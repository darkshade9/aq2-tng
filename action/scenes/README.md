...
#### Improvements
* Scene format
    * The original scene files were parsed via a Lex Yacc interpreter, long before JSON or YAML was a thing.  I think we can improve this by modernizing the file formats, making file ingestion more straightforward and linting when designing scenes more straightforward.
* Scoring
